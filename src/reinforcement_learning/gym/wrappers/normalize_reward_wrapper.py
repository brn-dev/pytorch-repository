...
#
#     Note:
#         The normalization depends on past trajectories and observations will not be normalized correctly if the
#         wrapper was newly instantiated or the policy was changed recently.
#     """
#
...
class NormalizeRewardWrapper(RewardWrapper, gymnasium.utils.RecordConstructorArgs):
    ...
    def step(self, action):
        ...
        self.returns = self.returns * self.gamma * (1 - terminated) + rewards
