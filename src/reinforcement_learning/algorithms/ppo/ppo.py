...
class PPO(OnPolicyAlgorithm[ActorCriticPolicy, RolloutBuffer, PPOLoggingConfig]):
    ...
    def collect_hyper_parameters(self) -> HyperParameters:
        return self.update_hps(super().collect_hyper_parameters(), {
            ...
            'weigh_and_reduce_entropy_loss': self.maybe_get_func_repr(self.weigh_and_reduce_entropy_loss),
            'critic_loss_fn': self.get_func_repr(self.critic_loss_fn),
            'weigh_and_reduce_critic_loss': self.get_func_repr(self.weigh_and_reduce_critic_loss),
