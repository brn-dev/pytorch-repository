...
__all__ = ["BatchRenorm", "BatchRenorm1d", "BatchRenorm2d", "BatchRenorm3d"]
...
class BatchRenorm(Net):
    ...
    def __init__(
        ...
        super().__init__(
            in_shape=TensorShape(num_features=num_features),
            out_shape=TensorShape(num_features=num_features),
        )
